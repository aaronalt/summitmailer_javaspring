...
public abstract class AbstractDao {
    ...
    protected AbstractDao(MongoClient mongoClient, String databaseName) {
        ...
        SummitMailDatabase = databaseName;
        this.db = this.mongoClient.getDatabase(SummitMailDatabase);
    }
    ...
    public Map<String, Object> getConfiguration() {
        ...
        Document connectionStatus = this.mongoClient.getDatabase(SummitMailDatabase).runCommand(command);
        List authUserRoles =
        ...
        if (!authUserRoles.isEmpty()) {
            ...
            configuration.put(
                    "wtimeout",
                    this.mongoClient
                            .getDatabase(SummitMailDatabase)
                            .getWriteConcern()
